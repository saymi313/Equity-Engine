            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="text-2xl font-bold text-slate-800">Cash Flow Analysis</h4>
                    <p className="text-slate-600">Monthly income, expenses, and net cash flow</p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <div className="w-full bg-slate-200 rounded-full h-4 relative overflow-hidden">
                  ...
                  <div 
                    ...
                    style={{width: `${(results.cashFlow / results.monthlyRent) * 100}%`}}
                  ></div>
                </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border border-emerald-200/50 p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-emerald-800">Gross Rent</h4>
                    <p className="text-sm text-emerald-600">Monthly rental income</p>
                  </div>
                </div>
                <div className="text-right">
            ...
            <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-2xl border border-red-200/50 p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-red-800">Operating Expenses</h4>
                    <p className="text-sm text-red-600">Monthly operating costs</p>
                  </div>
                </div>
                <div className="text-right">
